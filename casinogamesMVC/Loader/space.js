$(document).ready(function () {
    var oMain = new CMain({
        win_occurrence: 10,        //WIN PERCENTAGE.SET A VALUE FROM 0 TO 100.
        ...
        perc_win_bonus_prize_1: 90,       //OCCURENCE PERCENTAGE FOR PRIZE 1 IN BONUS
        perc_win_bonus_prize_2: 10,       //OCCURENCE PERCENTAGE FOR PRIZE 2 IN BONUS
        perc_win_bonus_prize_3: 0,       //OCCURENCE PERCENTAGE FOR PRIZE 3 IN BONUS
