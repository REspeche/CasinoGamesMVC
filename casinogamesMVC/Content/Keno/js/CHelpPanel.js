function CHelpPanel(){
    ...
    this._init = function(){
        ...
        _oText1Back = new createjs.Text(TEXT_HELP1," 24px "+SECONDARY_FONT, "#000000");
        ...
        _oText1 = new createjs.Text(TEXT_HELP1," 24px "+SECONDARY_FONT, "#ffffff");
        ...
        _oText2Back = new createjs.Text(TEXT_HELP2," 24px "+SECONDARY_FONT, "#000000");
        ...
        _oText2 = new createjs.Text(TEXT_HELP2," 24px "+SECONDARY_FONT, "#ffffff");
