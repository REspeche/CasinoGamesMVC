function CInterface(){
    ...
    this._init = function(){                
        ...
        _oMoneyDisplay = new CTextButton(370,CANVAS_HEIGHT - 225,oSprite,TEXT_CURRENCY +START_PLAYER_MONEY,PRIMARY_FONT,"#ffffff",40);
        _oMoneyDisplay.block(true);

        var oSprite = s_oSpriteLibrary.getSprite('plus_display');
        _oBetDisplay = new CTextButton(480,CANVAS_HEIGHT - 130,oSprite,"$1",PRIMARY_FONT,"#ffffff",40, false, s_oStage);
