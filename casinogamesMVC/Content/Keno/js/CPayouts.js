function CPayouts(iX, iY){
    ...
    this._init = function(iX, iY){
        ...
        for(var i=0; i<6; i++){
            ...
            _aHitsText[i] = new createjs.Text("-","bold 36px "+PRIMARY_FONT, "#ffffff");
            ...
            _aPaysText[i] = new createjs.Text("-","bold 36px "+PRIMARY_FONT, "#ffffff");
        ...
        _oMoneyText = new createjs.Text(TEXT_CURRENCY +"0","bold 40px "+PRIMARY_FONT, "#ffffff");
        _oMoneyText.x = 150;
        _oMoneyText.y = 646;
