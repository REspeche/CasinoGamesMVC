function CPreloader(){
    ...
    this._init = function(){
       ...
       s_oSpriteLibrary.addSprite("bg_preloader","./Content/Space/sprites/bg_preloader.jpg");
       s_oSpriteLibrary.addSprite("preloader_bar","./Content/Space/sprites/preloader_bar.png");
       s_oSpriteLibrary.addSprite("progress_bar","./Content/Space/sprites/progress_bar.png");
