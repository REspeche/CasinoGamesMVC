function CGame(oData){
    ...
    this.checkMoney = function(){
        if(_iMoney < _iCurBet){
            ...
            if (_iMoney < _iCurBet || LIMIT_BET < _iCurBet) {
        ...
        switch(_iCurState){
            ...
            case STATE_GAME_DRAW:{
                    ...
                    if(_iHandResult !== HIGH_CARD){
                        s_oGame.assignWin();
                        setTimeout(function(){_oDoubleUpPanel.show(_iCurWin,_iCurWin*2,_iCurWin*1.5);},5000);
                    } else {
                        $(s_oMain).trigger("save_score", [_iMoney]);
    ...
    LIMIT_BET = parseFloat(oData.limit_bet);
