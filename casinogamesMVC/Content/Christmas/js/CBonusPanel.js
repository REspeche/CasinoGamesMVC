function CBonusPanel(){
    ...
    this.show = function(iNumItems){
        ...
        _aBonusItemPrizes[0].text = _aBonusValue[0] + "$";
        _aBonusItemPrizes[1].text = _aBonusValue[1] + "$";
        _aBonusItemPrizes[2].text = _aBonusValue[2] + "$";
    ...
    this._onItemReleased = function(evt,oData){
		...
		}while(_aBonusValue[s_aBonusItemOccurence[iRandItem]] > SLOT_CASH);
