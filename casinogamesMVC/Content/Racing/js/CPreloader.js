function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("bg_preloader", "./Content/Racing/sprites/bg_preloader.jpg");
        s_oSpriteLibrary.addSprite("progress_bar", "./Content/Racing/sprites/progress_bar.png");
