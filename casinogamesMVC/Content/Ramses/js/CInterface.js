function CInterface(iCurBet,iTotBet,iMoney){
    ...
    this._init = function(iCurBet,iTotBet,iMoney){
        ...
        if(DISABLE_SOUND_MOBILE === false || s_bMobile === false){
            ...
            _pStartPosFullscreen = {x:_pStartPosAudio.x - oSprite.width,y:oSprite.height/2 + 20};
        }else{
            _pStartPosFullscreen = {x:_pStartPosExit.x - oSprite.width,y:oSprite.height/2 + 20};
        }
