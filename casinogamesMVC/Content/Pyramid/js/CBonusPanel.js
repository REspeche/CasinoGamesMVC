function CBonusPanel(){
    ...
    this._loadAllResources = function(){
       ...
       _oProgressBar.mask = _oMaskPreloader;
        ...
        //LOAD BONUS SPRITES
        s_oSpriteLibrary.addSprite("bg_bonus","./Content/Pyramid/sprites/bonus/bg_bonus.jpg");
        s_oSpriteLibrary.addSprite("ball_shadow","./Content/Pyramid/sprites/bonus/ball_shadow.png");
        s_oSpriteLibrary.addSprite("but_goal","./Content/Pyramid/sprites/bonus/but_goal.png");
        s_oSpriteLibrary.addSprite("ball_anim","./Content/Pyramid/sprites/bonus/ball_anim.png");
        s_oSpriteLibrary.addSprite("bonus_panel_bg","./Content/Pyramid/sprites/bonus/bonus_panel_bg.png");
        
        
        for(var k=0;k<23;k++){
            s_oSpriteLibrary.addSprite("gk_idle_"+k,"./Content/Pyramid/sprites/bonus/goalkeeper_idle/gk_idle_"+k+".png");
        }
        
        for(var s=0;s<33;s++){
            s_oSpriteLibrary.addSprite("gk_save_left_"+s,"./Content/Pyramid/sprites/bonus/goalkeeper_save_left/gk_save_left_"+s+".png");
            s_oSpriteLibrary.addSprite("gk_save_right_"+s,"./Content/Pyramid/sprites/bonus/goalkeeper_save_right/gk_save_right_"+s+".png");
        }
        
        for(var t=0;t<30;t++){
            s_oSpriteLibrary.addSprite("player_"+t,"./Content/Pyramid/sprites/bonus/player/player_"+t+".png");
        }
