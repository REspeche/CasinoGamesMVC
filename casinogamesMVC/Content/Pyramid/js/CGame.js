function CGame(){
    ...
    this._init = function(){
        ...
        _oSoundTrackCrowd = playSound("crowd",1,-1);
    ...
    this.stopNextReel = function(bContainsFreespin,bContainsBonus) {
        ...
        if(_iNumReelsStopped%2 === 0){
            ...
            if(bContainsBonus ){
                playSound("reel_stop_bonus",1,0);
            }else if(bContainsFreespin){
                playSound("reel_stop_freespin",1,0);
            }else{
    ...
    this._endReelAnimation = function(){
        ...
        if(_aWinningLine.length > 0){
            ...
            _oCurSymbolWinSound = playSound("avatar_win",1,0);
