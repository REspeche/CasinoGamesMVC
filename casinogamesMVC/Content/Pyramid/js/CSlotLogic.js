...
function _onSpin(iNumBettingLines,iCoin,iCurBet){
    ...
    if(iRandOccur < s_aSession["win_occurrence"]){
            ...
            do{
                ...
                iTotWin *= iCoin;
            }while(aRet.length === 0 || iTotWin > s_aSession["iSlotCash"] || iTotWin < iCurBet);
...
function _initSymbolWin(){
    ...
    _aSymbolWin[7] = [0,0,10,20,30];
    _aSymbolWin[8] = [0,0,5,15,50];
    _aSymbolWin[9] = [0,0,5,15,50];
    _aSymbolWin[10] = [0,0,5,15,50];
    _aSymbolWin[11] = [0,0,0,0,0,50];
    _aSymbolWin[12] = [0,0,0,0,0,50];
