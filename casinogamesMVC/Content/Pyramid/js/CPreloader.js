function CPreloader(){
    ...
    this._init = function(){
       ...
       s_oSpriteLibrary.addSprite("progress_bar","./Content/Pyramid/sprites/progress_bar.png");
    ...
    this.attachSprites = function(){
        var oBg = createBitmap(s_oSpriteLibrary.getSprite('bg_loading'));
       ...
       _oFakeLoadingtext = new createjs.Text("","30px "+FONT_GAME_2, "#fff");
       _oFakeLoadingtext.x = CANVAS_WIDTH;
       _oFakeLoadingtext.y = CANVAS_HEIGHT + 125;
       _oFakeLoadingtext.shadow = new createjs.Shadow("#000", 2, 2, 2);
       _oFakeLoadingtext.textBaseline = "alphabetic";
