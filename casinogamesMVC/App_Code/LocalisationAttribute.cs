namespace Web.Controllers
{
    ...
    internal class LocalisationAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            var culture = (string)filterContext.HttpContext.Request[LangParam];
            ...
            if (string.IsNullOrEmpty(culture) || !CultureHelper.isCultureExist(culture))
            {
                ...
                else
                {
                    ...
                    culture = filterContext.HttpContext.Application["locale_default"].ToString();
                }
            ...
            if (!filterContext.HttpContext.Session["locale"].ToString().Equals(culture)) filterContext.HttpContext.Session["locale"] = culture;
